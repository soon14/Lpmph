...
public class SsoUtil {
	...
	public static String ClientId;//应用客户端ID 
	public static String ClientSecret;//客户端密钥 
	public static String RedirectUri;//应用的回调URL
	...
	static {
		...
		SsoUtil.ClientId = Application.getValue("url.ssoClientId");
		SsoUtil.ClientSecret = Application.getValue("url.ssoClientSecret");
		SsoUtil.RedirectUri = Application.getValue("url.ssoRedirectUri");
	}
