...
!function ($) {
	...
	var bPage =  {
		...
		init : function(e,p){
			...
			htmlstr+='<ul>';
			htmlstr+='<li id="bPageList" class="disabled bPageList"><a><label>每页<select id="bPageDropList"></select>条</label></a></li>';
			var pageInfo = '当前显示第';
			pageInfo += p.pageNumber + '/' + p.totalPage + ' 页';
			pageInfo += '（共'+p.totalRow+'条记录）';
			htmlstr+='<li id="bPageInfo" class="disabled bPageInfo"><a>'+pageInfo+'</a></li>';
			htmlstr+='<li id="bPageFirstPage"><a href="javascript:void(0);">首页</a></li>';
			htmlstr+='<li id="bPagePreviousPage"><a href="javascript:void(0);">«</a></li>';
			htmlstr+='<li id="bPageNextPage"><a href="javascript:void(0);">»</a></li>';
			htmlstr+='<li id="bPageLastPage"><a href="javascript:void(0);">尾页</a></li>';
			htmlstr+='</ul>';
			htmlstr+='</div>';
			$(e).append(htmlstr);
			//设置分页设置每页显示条数的下拉列表
