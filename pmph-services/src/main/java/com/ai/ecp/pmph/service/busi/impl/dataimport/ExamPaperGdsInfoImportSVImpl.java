 ...
 * @since JDK 1.6
 */
public class ExamPaperGdsInfoImportSVImpl extends BaseGdsInfoImportSV implements IExamPaperGdsInfoImportSV {
...
//        }
    ...
    protected String getSrcGdsCodePrefix() throws BusinessException {
        return PmphGdsDataImportConstants.CodePreFix.ZY_EXAM_PAPER_ORIGN_CODE_PREFIX;
    }
...
//        gdsInfoReqDTO.setGdsStatus(GdsConstants.GdsInfo.GDS_STATUS_ONSHELVES);
    ...
    private List<String[]> createAddPropInfoList(Map map) throws BusinessException {
        ...
        //试卷的试题量
        if (this.isNotNull_(map,"UseTimes")) {
            propInfoList.add(new String[] { "1037", this.getValue_(map,"UseTimes") });
        }else{
            propInfoList.add(new String[] { "1037",""});
        }
        ...
        //考试网商品类型标识属性
        propInfoList.add(new String[] { "1040", PmphGdsDataImportConstants.Commons.ZY_EXAM_PROP_PAPER});
