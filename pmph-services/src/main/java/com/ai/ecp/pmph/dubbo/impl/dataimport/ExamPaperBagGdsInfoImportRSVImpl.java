...
import com.ai.ecp.pmph.dubbo.interfaces.dataimport.IExamPaperBagGdsInfoImportRSV;
 ...
 * @since JDK 1.6
 */
public class ExamPaperBagGdsInfoImportRSVImpl extends AbstractRSVImpl implements
        IExamPaperBagGdsInfoImportRSV {

    @Resource
    private IExamPaperBagGdsInfoImportSV examPaperBagGdsInfoImportSV;
    ...
    public void receive(Map<String, Object> map) {
        ...
        GdsInfoRespDTO gdsInfo=this.examPaperBagGdsInfoImportSV.saveGdsInfo(map);
