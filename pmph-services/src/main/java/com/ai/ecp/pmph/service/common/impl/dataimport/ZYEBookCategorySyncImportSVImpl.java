 ...
 * @since JDK 1.6
 */
public class ZYEBookCategorySyncImportSVImpl extends AbstractCategorySyncImportSV implements
	...
	protected GdsCatgSyncReqDTO buildGdsCatgSyncReqDTO(Map<String, Object> map) {
		...
		record.setSrcSystem(PmphGdsDataImportConstants.SrcSystem.ZY_01);
