...
import com.ai.ecp.pmph.dubbo.interfaces.dataimport.IExamTutorialClassGdsInfoImportRSV;
 ...
 * @since JDK 1.6
 */
public class ExamTutorialClassGdsInfoImportRSVImpl extends AbstractRSVImpl implements IExamTutorialClassGdsInfoImportRSV {
    
    @Resource
    private IExamTutorialClassGdsInfoImportSV examTutorialClassGdsInfoImportSV;
    ...
    public void receive(Map<String, Object> map) {
        ...
        GdsInfoRespDTO gdsInfo=this.examTutorialClassGdsInfoImportSV.saveGdsInfo(map);
