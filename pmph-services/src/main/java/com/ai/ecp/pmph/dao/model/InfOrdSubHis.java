...
public class InfOrdSubHis implements Serializable {
    private String id;
    ...
    public Long getInfGdsId() {
        return infGdsId;
    }

    public void setInfGdsId(Long infGdsId) {
        this.infGdsId = infGdsId;
    }
