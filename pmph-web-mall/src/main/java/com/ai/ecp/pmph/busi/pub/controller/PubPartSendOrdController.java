...
@Controller
@RequestMapping(value = "/pubord/partSend")
public class PubPartSendOrdController extends EcpBaseController {
    ...
    public String init(Model model,PubAllOrdVO vo) throws Exception {
    	...
    	String status = PubOrdConstants.CustomerRequestStatus.REQUEST_STATUS_PART_SEND;
