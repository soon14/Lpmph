...
@Controller
@RequestMapping(value = "/pubord/pay")
public class PubPayOrdController extends EcpBaseController {
    ...
    public String init(Model model,PubAllOrdVO vo) throws Exception {
    	...
    	String status = PubOrdConstants.CustomerRequestStatus.REQUEST_STATUS_PAY;
