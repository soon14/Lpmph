...
@Controller
@RequestMapping(value = "/pubord/cancel")
public class PubCancelOrdController extends EcpBaseController {
    ...
    public String init(Model model,PubAllOrdVO vo) throws Exception {
    	...
    	String status = PubOrdConstants.CustomerRequestStatus.REQUEST_STATUS_CANCLE;
