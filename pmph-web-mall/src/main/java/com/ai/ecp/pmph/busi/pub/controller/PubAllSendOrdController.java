...
@Controller
@RequestMapping(value = "/pubord/allSend")
public class PubAllSendOrdController extends EcpBaseController {
    ...
    public String init(Model model,PubAllOrdVO vo) throws Exception {
    	...
    	String status = PubOrdConstants.CustomerRequestStatus.REQUEST_STATUS_ALL_SEND;
