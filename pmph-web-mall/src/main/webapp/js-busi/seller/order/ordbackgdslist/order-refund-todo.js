...
$(function(){
    ...
    function(){
    	var init = function(){
    		var _load_url_ = '/seller/refundReview/queryOrder?';
			...
			$('.refundReview').click(function(){
				...
				$form.attr("action",GLOBAL.WEBROOT + '/seller/refundReview/review');
...
//			补偿性退款审核信息查询
			$('.refundReviewCompensateBack').click(function(){
				var $form = $("#backreviewForm");
				$form.attr("action",GLOBAL.WEBROOT + '/seller/refundReview/reviewCompensateBack');
				$form.attr("method","post");
				var tr = $(this).closest('tr');
				var orderId = $(".orderId",$(tr)).text();
				var backId = $(".backId",$(tr)).text();
...
//			补偿性退款详情信息查询
			$('.refundCompensatedetail').click(function(){
				var $form = $("#backreviewForm");
				var tr = $(this).closest('tr');
				var orderId = $(".orderId",$(tr)).text();
				var backId = $(".backId",$(tr)).text();
			...
			//确认退款
			$('.refundQueryRefund').click(function(){
				var tr = $(this).closest('tr');
				var orderId = $(".orderId",$(tr)).text();
				var backId = $(".backId",$(tr)).text();
