function addWithdrawLoadParamsToUrl(_load_url_) {
    ...
    var withdrawInit = function(){
    	var init = function(){
	    	...
	    	function queryWithdraw(){
	    		...
	    		var _load_url_ = '/seller/shopmgr/shopAcctDetail/withdrawlist?_t='+new Date().getTime();
...
//                $('#log-contentDiv').load(GLOBAL.WEBROOT + _load_url_, ebcForm.formParams($("#searchForm")));
                $('#pageMainBoxWithdraw').load(GLOBAL.WEBROOT + _load_url_);
