function addExpendLoadParamsToUrl(_load_url_) {
    ...
    var expendInit = function(){
    	var init = function(){
	    	...
	    	function queryExpend(){
	    		...
	    		var _load_url_ = '/seller/shopmgr/shopAcctDetail/expendlist?_t='+new Date().getTime();
...
//                $('#log-contentDiv').load(GLOBAL.WEBROOT + _load_url_, ebcForm.formParams($("#searchForm")));
                $('#pageMainBoxExpend').load(GLOBAL.WEBROOT + _load_url_);
